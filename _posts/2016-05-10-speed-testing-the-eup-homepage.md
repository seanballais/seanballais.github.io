...
This does not aim to be a comprehensive speed test. This test only uses the data gathered from Chrome Web Developer Tools. You might get different results with your current setup. With that, I encourage you to perform your own tests and maybe share your results in the comments below.
