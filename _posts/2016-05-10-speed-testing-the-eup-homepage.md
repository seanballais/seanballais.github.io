...
**Disclaimer**: This does not aim to be a comprehensive speed test. This test only uses the data gathered from Chrome Web Developer Tools and is limited to the home page and not the whole site. You might get different results with your current setup or have a different method of testing. With that, I encourage you to perform your own tests and share your results in the comments below.
